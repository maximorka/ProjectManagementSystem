package com.model.feature.dataBaseService.developerSkills.dao;
...
public class DeveloperSkillsDao {
    ...
    public DeveloperSkillsDao(Connection connection) throws SQLException {
        ...
        deleteSt = connection.prepareStatement("DELETE FROM developer_skills WHERE dev_id=? AND skills_id=?");
        updateByIdSt = connection.prepareStatement("UPDATE developer_skills SET dev_id=?, skills_id=? WHERE dev_id=? AND skills_id=?");
    }

    public boolean createDeveloperSkills(DeveloperSkills developerSkills) throws SQLException {
    ...
    public List<DeveloperSkills> getAllDeveloperSkills() throws SQLException {
    ...
    public boolean deleteDeveloperSkills(long develop_id, long skills_id ) {
        try {
            deleteSt.setLong(1, develop_id);
            deleteSt.setLong(2, skills_id);
