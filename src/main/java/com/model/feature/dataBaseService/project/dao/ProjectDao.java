package com.model.feature.dataBaseService.project.dao;
...
public class ProjectDao {
    ...
    public boolean updateProject(Project project) {
        try {
            ...
            updateByIdSt.setInt(5, project.getCost());
            updateByIdSt.setDate(6, (Date) project.getDate());
            updateByIdSt.setLong(7, project.getId());
